...
class SoldiersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create soldier" do
    assert_difference("Soldier.count") do
      post soldiers_url, params: { soldier: { dateofbirth: @soldier.dateofbirth, galon_id: @soldier.galon_id, image: @soldier.image, name: @soldier.name, user_id: @soldier.user_id } }
    end
  ...
  test "should update soldier" do
    patch soldier_url(@soldier), params: { soldier: { dateofbirth: @soldier.dateofbirth, galon_id: @soldier.galon_id, image: @soldier.image, name: @soldier.name, user_id: @soldier.user_id } }
